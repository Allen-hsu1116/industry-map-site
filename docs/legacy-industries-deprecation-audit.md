...
- Direct non-generated consumers found after S25: **1 runtime UI**, **2 runtime libs**, **2 scripts**, **2 test areas**, **6 docs**, plus legacy data snapshots. The generator-side `legacyIndustryAnalysis` adapter has been removed.
- Generated analysis files currently containing legacy provenance: **0** after S24/S25 canonical-only generation.
- Current coverage report after S24/S25: **A=28, B=5, C=22, D=0, F=450**. This is enough to retire generator fallback, but not enough to delete the legacy UI/data baseline.
